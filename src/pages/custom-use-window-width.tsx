...
const PageUseWindowWidth = () => {
    ...
    return (
        <section className="flex flex-col gap-4 mb-12">
            <h1 className="text-3xl md:text-5xl mb-12 font-bold">useWindowWidth</h1>
            <p>Este es un custom hook en el que combinando useState y useEffect vamos a lograr añadir <code>resize</code> a <code>window</code> y recuperar el resultado sin nunca dejar de escuchar el evento. Muy útil cuando quieres realizar algo en determinadas resoluciones.</p>
